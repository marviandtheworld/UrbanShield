-- Fix Image Display Issue - Corrected Version
-- This script fixes the database function to use only existing columns

-- 1. First, let's check what columns actually exist
SELECT 
    'CURRENT INCIDENTS COLUMNS' as info,
    column_name,
    data_type
...
-- 2. Update the function to use only existing columns
...
-- 5. Check specific incident with images
SELECT 
    'SAMPLE INCIDENT WITH IMAGES' as info,
    id,
    title,
    images,
...
-- 6. Check recent incidents overview
SELECT 
